...
// compares two month-days, and besides a PlainMonthDay argument it accepts an ISO string or a
// month-day-like bag, coercing it to a PlainMonthDay first through ToTemporalMonthDay, so it tests
// against the month-day the argument names rather than handing back. from over a PlainMonthDay
// returns a fresh copy. The values match @js-temporal/polyfill.
...
console.log(md.equals({ month: 3, day: 16 }));
